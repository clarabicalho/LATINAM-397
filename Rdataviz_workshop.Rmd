...
ggplot(plot_data, aes(x = townmeeting_lbl, y = pct, fill = indig_lbl)) +
  ...
  geom_text(aes(label = paste0(sprintf("%1.0f", pct), "%")),
            ...
            vjust = -0.5, size = 3) +
  scale_y_continuous(limits = c(0, max(plot_data$pct) + 5)) + # Adjust y-axis limits to fit labels
  labs(
